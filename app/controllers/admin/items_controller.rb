class Admin::ItemsController < ApplicationController
  ...
  # GET /items.json
  def index
    @items = Item.includes(:categories).order(created_at: :desc).page(params[:page]).per(10)
  end
  ...
  private
    ...
    def item_params
      params.require(:item).permit(:name, :description, :stock, :profit_margin, :amount, :ratio_1, :ratio_2, :ratio_3, :ratio_4, :ratio_5, :new_category_name, category_ids: [])
    end
end
